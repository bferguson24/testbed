...
class ScoopGUI:
    ...
    def create_widgets(self):
        ...
        tk.Button(self.root, text="Home", command=self.scoop.home).grid(row=0, column=3, padx=10, pady=10)
        tk.Button(self.root, text="Run Dig", command=self.scoop.dig_sequence).grid(row=1, column=0, padx=10, pady=10)
        tk.Button(self.root, text="Manual Control", command=self.scoop.manual_control).grid(row=1, column=1, padx=10, pady=10)
        ...
        self.toggle_data_button.grid(row=1, column=2, padx=10, pady=10)
